...
export const register = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    // recieving the user data (token-cookie)
...
// logout function --> destroy the cookie
...
// get user function--> get the user data
...
// update profile function --> put method
